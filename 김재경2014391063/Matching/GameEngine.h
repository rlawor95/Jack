...
void HandleJoystick(Sprite* pSpriteHitter, Sprite* pSpriteHittee);
...
public:
	GameEngine(HINSTANCE hInstance, LPTSTR szWindowClass, LPTSTR szTitle,
		WORD wlcon, WORD wSmallIcon, int iWidth = 640, int iHeight = 480);
	virtual ~GameEngine();
